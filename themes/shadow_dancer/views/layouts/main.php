...
$this->widget('application.extensions.mbmenu.MbMenu',array(
            'items'=>array(
                ...
                array('label'=>'Theme Pages',
                  'items'=>array(
                    array('label'=>'Graphs & Charts', 'url'=>array('/site/page',
                    	 'view'=>'graphs'),'itemOptions'=>array('class'=>'icon_chart')),
...
array('label'=>CHtml::image(Yii::app()->theme->baseUrl."/images/big_icons/icon-down.png","",array("width"=>20,"heigth"=>20,'style' => 'vertical-align:10px;')). CHtml::label("  Descargar", "",array('style' => 'vertical-align:15px;')),
	'items'=>array(array('label'=>'Aseos', 'url'=>array('/site/bajar')),
                    array('label'=>'Evaluaciones', 'url'=>array('/site/bajarevaluaciones')),   
					)
	  ),
                                

array('label'=>CHtml::image(Yii::app()->theme->baseUrl."/images/big_icons/icon-warning.png","",array("width"=>20,"heigth"=>20,'style' => 'vertical-align:10px;')). CHtml::label("  Críticos", "",array('style' => 'vertical-align:15px;')), 
	'items'=>array(array('label'=>'Resumen', 'url'=>array('/site/resumencriticos')),
                    array('label'=>'Lista completa', 'url'=>array('/site/criticos')),   
	 )),
