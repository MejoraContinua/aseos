...
class AseoController extends Controller
{
	...
	public function accessRules() {
        ...
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('create', 'update','GetTipoByPond'),
                'users' => array('@'),
                'expression'=>$isUser
            ),
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('admin', 'delete','GetTipoByPond'),
                'users' => array('@'),
                'expression'=>$isAdmin,
            ),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Aseo']))
		{
			$model->attributes=$_POST['Aseo'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_ASEO));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Aseo');
	...
	{
		$model=new Aseo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Aseo']))
			$model->attributes=$_GET['Aseo'];
	 ...
	 * @return Aseo the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Aseo::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Aseo $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='aseo-form')
		{
